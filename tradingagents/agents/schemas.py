...
class PortfolioDecision(BaseModel):
    ...
    arguments_table: str = Field(
        description=(
            ...
            "priority used by the research team: Business Analyst, "
            "Fundamentals Analyst, and Sector Specialist arguments carry "
            "the most weight (typically High impact), while Macro, Market, "
            "and News Analyst arguments carry less (typically Medium or Low "
            "impact). The table "
